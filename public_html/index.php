        ...
        <template slot='left'>
            ...
            <li class="nav-item navthing">
                <a class='btn btn-outline-secondary' target='_blank'
                   href='https://www.wikidata.org/wiki/User:Magnus_Manske/quick_statements2' tt='brainstorming'></a>
            </li>
            <li class="nav-item navthing">
                <a class='btn btn-outline-secondary' target='_blank'
                   href='https://github.com/magnusmanske/quickstatements' tt='git'></a>
            </li>
            <li class="nav-item navthing">
                <a class='btn btn-outline-info' target='_blank'
                   href='https://www.wikidata.org/wiki/Help:QuickStatements' tt='help'></a>
            </li>
